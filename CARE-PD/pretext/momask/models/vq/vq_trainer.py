    ...
    def train(self, train_loader, val_loader, eval_val_loader, eval_wrapper, plot_eval=None):
        ...
        while epoch < self.opt.max_epoch:
            ...
            for i, batch_data in enumerate(train_loader):
                word_embeddings, pos_one_hots, caption, sent_len, motion, m_length, token = batch_data
                it += 1
            ...
            best_fid, best_div, best_top1, best_top2, best_top3, best_matching, best_mpjpe, mpjpe, writer = evaluation_vqvae(
                ...
                best_top2=best_top2, best_top3=best_top3, best_matching=best_matching, best_mpjpe=best_mpjpe, eval_wrapper=eval_wrapper)
            ...
            log = {
                'train/loss': logs['loss']/ cur_iter,
                'train/loss_rec': logs['loss_rec']/ cur_iter,
                'train/loss_vel': logs['loss_vel']/ cur_iter,
                'train/loss_commit': logs['loss_commit']/ cur_iter,
                'train/perplexity': logs['perplexity']/ cur_iter,
                'train/lr': logs['lr']/ cur_iter,
                'eval/loss': sum(val_loss) / len(val_loss),
                'eval/best_mpjpe': best_mpjpe,
                'eval/mpjpe': mpjpe,
            }
